...
public class SimpleMenuTree extends SimpleMenu implements TreeNode {
  ...
  public static SimpleMenuTree of(@Nonnull SimpleMenu simpleMenu) {
    ...
    simpleMenuTree.setIcon(simpleMenu.getIcon());
    simpleMenuTree.setSelectedIcon(simpleMenu.getSelectedIcon());
    simpleMenuTree.setUrl(simpleMenu.getUrl());
    simpleMenuTree.setPath(simpleMenu.getPath());
